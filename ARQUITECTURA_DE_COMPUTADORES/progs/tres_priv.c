...
// Usa threads con contadores privados para cada thread
...
void main(int argc, char *argv[])
{
  ...
  printf("TRES: %d (%f secs)\n", tc, ((tf.tv_sec - ts.tv_sec) * 1000000u + tf.tv_usec - ts.tv_usec) / 1.e6);
  exit(0);
}
